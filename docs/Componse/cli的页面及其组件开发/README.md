...
| [05-终端清空功能实现.md](./05-终端清空功能实现.md)     | ANSI 转义序列、清空屏幕和滚动缓冲区      | ~1,500 字 |
| [06-终端滚动区域实现.md](./06-终端滚动区域实现.md)     | Ink Static 组件、原生滚动、固定底部布局  | ~3,000 字 |
...
- ✅ 新增 05-终端清空功能实现.md（ANSI 转义序列详解）
- ✅ 新增 06-终端滚动区域实现.md（Ink Static 组件使用指南）
